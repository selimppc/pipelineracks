...
function my_custom_post_product() {
	...
	$args = array(
		...
		'hierarchical'	=> false,
		'rewrite'		=> array('slug' => 'products4/%brand%','with_front' => true),
...
function my_custom_post_apparel() {
    ...
    $args = array(
        ...
        'supports'      => array( 'title', 'editor', 'thumbnail','custom-fields', 'excerpt', 'comments' ),
        'hierarchical'	=> false,
        'rewrite'		=> array('slug' => 'apparel','with_front' => true),
        #'rewrite'		=> array('slug' => 'apparel/%category%','with_front' => true),
        //'rewrite' => array('slug' => 'products/nike','with_front' => false),
        'query_var'		=> true,
        //'rewrite'		=> true,
        //'publicly_queryable' => false,
...
add_action( 'init', 'my_custom_post_apparel' );

/*Creo la custom taxonomy Brand associata a Prodotti*/
function my_taxonomies_apparel() {
    $labels = array(
        'name'              => _x( 'Apparel Category', 'taxonomy general name' ),
        'singular_name'     => _x( 'Apparel Category', 'taxonomy singular name' ),
        'search_items'      => __( 'Search Apparel Categories' ),
        'all_items'         => __( 'All Apparel Categories' ),
        'parent_item'       => __( 'Parent Apparel Category' ),
        'parent_item_colon' => __( 'Parent Apparel Category:' ),
        'edit_item'         => __( 'Edit Apparel Category' ),
        'update_item'       => __( 'Update Apparel Category' ),
        'add_new_item'      => __( 'Add New Apparel Category' ),
        'new_item_name'     => __( 'New Apparel Category' ),
        'menu_name'         => __( 'Apparel Category' ),
    );
    $args = array(
        'labels' => $labels,
        'hierarchical' 	=> true,
    ...
    register_taxonomy( 'category', 'apparel', $args );
}
add_action( 'init', 'my_taxonomies_apparel', 0 );
...
function twentytwelve_widgets_init() {
	...
	register_sidebar( array(
		'name' => __( 'Photo Gallery', 'twentytwelve' ),
		'id' => 'sidebar-2',
